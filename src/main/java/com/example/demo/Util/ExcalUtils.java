...
public class ExcalUtils {
    ...
    public static double handleDoubleXSSF(XSSFCell xssfCell){
        if (xssfCell ==null){
            return 0;
        }else {
            return (double)xssfCell.getNumericCellValue();
        }
    }
    public static double handleDoubleHSSF(HSSFCell hssfCell){
        if (hssfCell ==null){
            return 0;
        }else {
            return (double)hssfCell.getNumericCellValue();
        }
    }
}
